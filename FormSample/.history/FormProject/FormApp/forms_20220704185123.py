...
class UserInfo(forms.Form):
    ...
    #-2. フィールドに対して、validators=[]で属性を追加する field ~ forms.CharField(validators = [○○]) # ○○には、djangoのライブラリ内のクラス (https://docs.djangoproject.com/ja/3.1/ref/validators/#built-in-validators) 自作の関数を入れる
