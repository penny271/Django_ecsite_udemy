...
from .views import(
    CartUpdateView, ProductListView,ProductDetailView,add_product, CartItemsView, CartUpdateForm, CartDeleteView,InputAddressView,ConfirmOrderView,OrderSuccessView
)
