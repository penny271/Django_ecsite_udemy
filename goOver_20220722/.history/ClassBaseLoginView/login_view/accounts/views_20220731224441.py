...
#- (LoginView)を使うと、(FormView)と違い、next=/accounts/user/ の情報を取得する処理なしに、djangoが適切なurlへredirectしてくれる
class UserLoginView(LoginView):
    template_name = 'user_login.html'
    authentication_form = UserLoginForm

    def form_valid(self, form):
        remember = form.cleaned_data
...
class UserLogoutView(LogoutView):
    pass
    #- settings.pyで LOGOUT_REDIRECT_URLを書くだけでクラスの中身は空でよい
