...
def delete_picture(request, pk):
    ...
    if os.path.isfile(picture.picture.path):
        print('picture.picture: ', picture.picture)
        print('picture.picture dir: ', dir(picture.picture))
        print('picture.picture.path: ', picture.picture.path)
        print('picture.picture.path: ', picture.picture.open)
