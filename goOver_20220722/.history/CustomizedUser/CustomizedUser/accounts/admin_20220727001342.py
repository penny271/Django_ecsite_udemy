...
# admin.site.register(User) #- 初期の設定のまま
admin.site.register(User, CustomizeUserAdmin) #- カスタマイズした内容を反映するには第二引数にUserAdminを継承したクラスを入れる
# admin.site.register(Students) #^ @admin.register(class名) で代用のためコメント
