...
#! PermissionsMixin に is_superuserフィールドも入っているので作成する必要なし
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    #- このテーブルを一意に識別するフィールドを指定
    #- そのフィールドを unique=Trueにしておく必要あり
    USERNAME_FIELD = 'email'
    #スーパーユーザ作成時に追加で入力するもの
    #! USERNAME_FIELD と passwordはスーパーユーザ作成時に必須なのでそれ以外を選択する
