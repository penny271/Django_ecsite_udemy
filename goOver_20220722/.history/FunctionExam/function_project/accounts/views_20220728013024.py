...
def change_password(request):
    ...
    if password_change_form.is_valid():
        try:
            ...
            #- add_error('password', e)は、contextの中に含まれ、html上で{{ password_change_form.as_p }}の中に含まれているのでエラーが有った場合は画面に表示される
            #! settings.py のvalidationの内容がpassword_change_form.errorsに入っている
