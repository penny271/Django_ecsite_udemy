...
class Addresses(models.Model):
    ...
    class Meta:
        ...
        #- ecsite_project/templates/stores/input_address.html過去に利用したアドレスに残すものを重複しないようにする
...
#     #- 下記の用に実行しても問題なかった。cart:Cartsの用途が不明のまま
#     # def insert_cart(self, cart, address, total_price):
#         #- レコードのインスタンスを返す
#         return self.create(
