...
for test in student_1.testsresults_set.all():
    print(dir(studtestent_1))

    print(test.name, test.testsresults_set.first().test.name,test.testsresults_set.first().score, )
