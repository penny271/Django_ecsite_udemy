...
#- GROUP BY クラス名, テスト名
for class_summary in Classes.objects.values('name', 'students__testresults__tests__name').annotate(
    max_score = Max('students__testresults__score'),
    min = Max('students__testresults__score'),
    avg = Max('students__testresults__score'),
    max_score = Max('students__testresults__score'),
):
