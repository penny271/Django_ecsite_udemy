...
book1 = Books.objects.get(pk=16)
book2 = Books.objects.get(pk=17)

author1 = Authors.objects.get(pk=16)
author2 = Authors.objects.get(pk=17)
author3 = Authors.objects.get(pk=18)
#- addする際のクラス名は大文字ではなく小文字に直す必要あり or error
...
# book1.authors.add(author1,author2)
book2.authors.add(author1,author2,author3)
